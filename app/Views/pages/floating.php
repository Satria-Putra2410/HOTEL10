    ...
    <!-- Section ARTIKEL -->
     <article class="h-screen bg-gray-900 text-white py-10 px-6">
        <div class="max-w-5xl mx-auto">
            <h2 class="text-3xl font-bold mb-4 text-center">Floating Market Lembang</h2>
            <p class="text-lg leading-relaxed mb-4">
            Floating Market Lembang adalah salah satu destinasi wisata favorit di Bandung yang menawarkan pengalaman unik berbelanja dan menikmati kuliner di atas perahu. Terletak di kawasan sejuk Lembang, tempat ini menjadi tujuan utama bagi wisatawan yang ingin merasakan suasana pasar terapung khas Indonesia dengan nuansa pegunungan yang asri.
            </p>
            <p class="text-lg leading-relaxed mb-4">
            Di sini, pengunjung bisa mencicipi berbagai hidangan lokal seperti batagor, nasi bakar, sate, dan aneka minuman segar langsung dari perahu-perahu yang berjejer di atas danau. Tak hanya itu, Floating Market juga memiliki berbagai wahana menarik seperti taman bunga, kereta mini, penyewaan kostum Jepang dan Korea, hingga tempat bermain anak.
            </p>
            <p class="text-lg leading-relaxed mb-4">
            Lokasinya yang tidak terlalu jauh dari pusat Kota Bandung menjadikan tempat ini sangat mudah dijangkau. Bagi tamu Hotel Sepuluh, Floating Market hanya berjarak sekitar 30–40 menit perjalanan dengan mobil, menjadikannya pilihan sempurna untuk mengisi akhir pekan bersama keluarga atau teman.
            </p>
            <p class="text-lg leading-relaxed">
            Jika Anda mencari wisata yang menyatukan alam, budaya, dan kuliner dalam satu tempat, maka Floating Market Lembang adalah destinasi yang tidak boleh dilewatkan.
            </p>
        </div>
     </article>
