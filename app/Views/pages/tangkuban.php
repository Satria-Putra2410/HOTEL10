...
<html>
  <head>
    ...
    <style>
      .bgbandung {
        background-image: url('assets/tangkuban.jpg');
    ...
    <!-- Section ARTIKEL -->
     <article class="h-screen bg-gray-900 text-white py-10 px-6">
        <div class="max-w-5xl mx-auto">
            <h2 class="text-3xl font-bold mb-4 text-center">Tangkuban Perahu</h2>
            <p class="text-lg leading-relaxed mb-4">
            Gunung Tangkuban Perahu merupakan salah satu ikon wisata paling terkenal di Bandung. Terletak di utara Kota Bandung, gunung berapi aktif ini dikenal dengan bentuknya yang menyerupai perahu terbalik—terinspirasi dari legenda Sangkuriang yang populer di kalangan masyarakat Sunda.
            </p>
            <p class="text-lg leading-relaxed mb-4">
            Pengunjung dapat menikmati pemandangan kawah vulkanik yang menakjubkan, seperti Kawah Ratu dan Kawah Domas, yang masing-masing memiliki daya tarik tersendiri. Selain berfoto dengan latar alam eksotis, wisatawan juga bisa berjalan kaki di jalur trekking, membeli oleh-oleh khas seperti belerang alami, dan menikmati udara pegunungan yang sejuk.
            </p>
            <p class="text-lg leading-relaxed mb-4">
             Jarak dari Hotel Sepuluh ke Tangkuban Perahu hanya sekitar 45 menit hingga 1 jam perjalanan. Tempat ini sangat cocok dikunjungi oleh keluarga, pasangan, maupun wisatawan yang ingin menyegarkan pikiran sambil mengenal cerita rakyat lokal. Gunung Tangkuban Perahu adalah perpaduan sempurna antara keindahan alam dan kekayaan budaya Sunda yang sayang untuk dilewatkan.
            </p>
        </div>
     </article>
